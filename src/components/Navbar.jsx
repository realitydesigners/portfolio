...
export default function Navbar() {
  ...
  return (
    <nav
      role="navigation"
      id="navbar"
      className="flex items-center justify-between z-80  fixed w-full z-50 h-auto"
    >
      ...
      <a href="/" className="flex lg:flex text-gray-200 pt-2 pb-2 flex-col">
        <span className="text-md font-russo normal font-bold tracking-wide leading-none">
          raymondreamer
        </span>
      </a>
          ...
          <ul className="flex font-bold relative  p-2 gap-2 h-auto lg:h-auto flex-col  lg:justify-end uppercase text-black text-3xl lg:text-4xl">
            <li>
              <a
                href="#projects"
                onClick={closeNav}
                className="block flex items-center px-3 py-1 text-gray-200 hover:bg-gray-200/30 rounded-lg"
              >
                <svg
